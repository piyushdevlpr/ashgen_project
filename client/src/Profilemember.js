...
class Profile extends Component {
    ...
    async getfriends(){
      await fetch("http://localhost:2000/get-friends2", {
  ...
  async getpeoplewithnotis(){
    
     await fetch("http://localhost:2000/get-notis", {
   ...
   async fetchProfile(username,id){
     await axios.get('http://localhost:2000/fetch_clicked_member_profile/'+username+'/'+id ,{withCredentials: true}).then((response)=>{
    ...
    fetchAchievements(){
      ...
      {
        axios.get('http://localhost:2000/clicked_member_achievement/'+this.state.username+'/'+this.state.id,{withCredentials: true})
    ...
    fetchProjects(){
      ...
      {
        axios.get('http://localhost:2000/clicked_member_project/'+this.state.username+'/'+this.state.id,{withCredentials: true})
                        ...
                        <div className="main-left-sidebar">
                          <div className="user_profile">
                            <div className="user-pro-img">
                              <img src={this.state.memberData.profilePhoto} alt />
